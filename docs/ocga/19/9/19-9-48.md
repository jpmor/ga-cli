...
(c) The immunity granted by subsection (a) of this Code section does not extend to civil litigation based on acts unrelated to the participation in a proceeding under this article committed by an individual while present in this state.
