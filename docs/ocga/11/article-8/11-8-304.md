...
(f) Unless otherwise agreed, a person making an indorsement assumes only the obligations provided in Code Section 11-8-108 and not an obligation that the security will be honored by the issuer.
